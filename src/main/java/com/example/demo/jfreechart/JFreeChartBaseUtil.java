...
public class JFreeChartBaseUtil {
    ...
    /*
     * public static Color[] CHART_COLORS = { new Color(31, 129, 188), new
     * Color(241, 92, 128), new Color(124, 181, 236), new Color(102, 172, 204),
     * new Color(102, 102, 0), new Color(204, 153, 102), new Color(0, 153, 255),
     * new Color(204, 255, 255), new Color(51, 153, 153), new Color(255, 204,
     * 102), new Color(102, 102, 0), new Color(204, 204, 204), new Color(204,
     * 255, 255), new Color(255, 204, 204), new Color(255, 255, 204), new
     * Color(255, 153, 204), new Color(51, 0, 0), new Color(0, 51, 102), new
     * Color(0, 153, 102), new Color(153, 102, 153), new Color(102, 153, 204),
     * new Color(153, 204, 153), new Color(204, 204, 153), new Color(255, 255,
     * 153), new Color(255, 204, 153), new Color(255, 153, 204), new Color(204,
     * 153, 153), new Color(204, 204, 255), new Color(204, 255, 204), new
     * Color(153, 204, 153), new Color(255, 204, 102) };// 颜色
     */
     ...
     * @param show2 
     * @return 
     * @create: 2015年12月22日 上午10:03:02 lyuanx
     * @history:
     */
    public static StandardChartTheme chartTheme(Boolean show2) {
        // 设置中文主题样式 解决乱码
