...
/**
 * The PathHandler is used to map file patterns to keys, and find an approriate
 ...
 *
 * <blockquote><code>
 * PathHandler pm = new PathHandler();<br>
 * <br>
 * pm.put("/", one);<br>
 * pm.put("/mydir/*", two);<br>
 * pm.put("*.xml", three);<br>
